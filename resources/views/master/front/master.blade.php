...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}front/assets/css/xzoom.css" />
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{asset($CartProduct->options->image)}}" alt="#"></a>
                                            </div>
                                            <div class="content">
                                                <h4><a href="product-details.html">
                                                       {{$CartProduct->name}} - {{$CartProduct->price}} * {{$CartProduct->qty}}</a></h4>
                                                <p class="quantity"><span class="amount">TK. {{$CartProduct->price * $CartProduct->qty}}</span></p>
                                            </div>
                                        </li>
