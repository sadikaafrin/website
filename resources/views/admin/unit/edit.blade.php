                ...
                <div class="card-body">
                    ...
                    <form action="{{route('unit.update', ['id' => $unit->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$unit->name}}" name="name" id="horizontal-firstname-input" placeholder="Enter Brand Name">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Unit Description</label>
                            <div class="col-sm-9">
                                <textarea type="email" class="form-control" name="description" id="horizontal-email-input" placeholder="Brand Description">{{$unit->description}}</textarea>
                            </div>
                        </div>
